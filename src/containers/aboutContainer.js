    ...
    return (
      <div id="About" className="header-container pb-4 blurrable">
        <div className="d-flex flex-column h-600 header-container d-flex justify-content-center ">
          <div id="About" className="padding-top-base h-600 header-container d-flex justify-content-center bg-about-img-mobile blurrable" style={{ backgroundImage: `url(${AboutImage})` }}>
            <div className="d-flex flex-column mx-4 align-self-center pb-4">
              <div className="align-self-center justify-self-end max-info-header">
                <h1>About me</h1>
                <p>
                  Hi, I&apos;m Gabriel, an enthusiastic problem solver.
                  I&apos;m from Brazil. I have a Bachelors in Information Systems and
                  I studied Software Engineering at Microverse.
                  I have more than 5 years experience in mainframe and web programming.
                  I also have experience with other tools/languages listed below.
          ...
          <span className="line-separator-white mb-4" />
        </div>
  ...
  return (
    <div id="About" className="padding-top-base header-container blurrable pb-4">
      <div className="d-flex flex-column">
        ...
        <span className="line-separator-white mb-4 vw-90" />
      </div>
