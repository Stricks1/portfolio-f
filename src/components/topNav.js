...
const Nav = () => {
  ...
  if (width < breakpoint) {
    return (
      <div id="nav-links" className="px-3 py-2 w-100 d-flex justify-content-between text-white blurrable">
  ...
  return (
    <nav id="nav-links" className="py-2 w-100 d-flex justify-content-between text-white blurrable">
