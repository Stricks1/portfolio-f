    ...
    return (
      <div className="mt-2 border-footer d-flex flex-column justify-content-center align-items-center text-white blurrable">
        <ul className="my-2 list-unstyled footer-width list-group list-header d-flex flex-row justify-content-between">
          ...
          <li>
            <a href="https://www.linkedin.com/in/gabriel-malheiros-silveira/" target="_blank" title="linkedin" className="grey-color2">
              <i className="fa fa-linkedin" />
            </a>
          </li>
          <li>
            <a href="https://twitter.com/gabriel_stricks" target="_blank" title="twitter" className="grey-color2">
              <i className="fa fa-twitter" />
            </a>
          </li>
          <li>
            <a href="https://angel.co/u/gabriel-malheiros-silveira" target="_blank" title="angellist" className="grey-color2">
